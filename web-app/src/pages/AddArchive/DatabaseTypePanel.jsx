...
export default function DatabaseTypePanel({ databaseEngine,
    setDatabaseEngine }) {
                    ...
                    items={[
                        {
                            ...
                            image: <img height="100px" src={require("./oracle.png")} alt="Oracle®" aria-hidden="true" />,
                        },
                        {
                            value: "mysql",
                            label: "MySQL",
                            ...
                            image: <img height="100px" src={require("./mysql.png")} alt="MySQL" aria-hidden="true" />,
                        },
                        {
                            value: "mssql",
