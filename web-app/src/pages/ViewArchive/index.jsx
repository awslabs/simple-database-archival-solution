                ...
                <>
                        ...
                        {loading ? (
                                        ...
                                        actions={
                                            <SpaceBetween direction="horizontal" size="xs">
                                                <Button
                                                    onClick={archiveItem}
                                                    disabled={
                                                        archiveState === 'Archive Queue' ? false : true
                                                    }
                                                >
                                                    Archive
                                                </Button>
                            ...
                            >
                                <ColumnLayout columns={2} variant="text-grid">
                                    ...
                                    <div>
                                        <Box variant="awsui-key-label">Archive ID</Box>
                                        <div>{job.id}</div>
                                    </div>

                                    <div>
                                        <Box variant="awsui-key-label">Time Submitted</Box>
                                        <div>
                                            {' '}
                                            <Moment
                                    ...
                                    <div>
                                        <Box variant="awsui-key-label">Archive Status</Box>
                                        ...
                                        <div>
                                            ...
                                            {archiveState === 'Failed' ? (
                                                ...
                                                <Badge color="blue">Archiving</Badge>
                                            ) : archiveState === 'Validating' ? (
                                                <Badge color="blue">Validating</Badge>
                                            ) : archiveState === 'Archive Queue' ? (
                                    ...
                                    <div>
                                        <Box variant="awsui-key-label">Database Engine</Box>
                                        <div>{archiveData.Item.database_engine}</div>
                                    </div>

                                    <div>
                                        <Box variant="awsui-key-label">Database Mode</Box>
                                        <div>
                                            {' '}
                                            {job.mode === 'Read' ? (
                    ...
                    <Modal
                        ...
                        footer={
                            <Box float="right">
                                <SpaceBetween direction="horizontal" size="xs">
                                    <Button onClick={closeArchiveModel} variant="link">
                                        Cancel
                                    </Button>
                                    <Button onClick={archiveRequest} variant="primary">
                                        Archive
                                    </Button>
                                </SpaceBetween>
                            </Box>
                    ...
                    >
                        <>
                            <SpaceBetween direction="vertical" size="xs">
                                <RadioGroup
                                    onChange={({ detail }) => setArchiveNow(detail.value)}
                                    value={archiveNow}
                                    items={[
                                        {
                                            value: 'now',
