...
export function ArchivesTable() {
    ...
    const [preferences, setPreferences] = useState({
        pageSize: 15,
        visibleContent: ['name', 'id', 'type', 'database_engine', 'archive_status'],
    });
    ...
    return (
        <>
                    ...
                    <TableHeader
                        ...
                        actionButtons={
                            <SpaceBetween direction="horizontal" size="xs">
                                ...
                                >
                                    <Button disabled={!isSelected}>View details</Button>
                                </Link>

                                <Button onClick={deleteItem} disabled={!isSelected}>
                                    Delete
                                </Button>
                                <Button
                                    onClick={refresh}
                ...
                footer={
                    <Box float="right">
                        <SpaceBetween direction="horizontal" size="xs">
                            ...
                            <Button onClick={confirmDeleteItem} variant="primary">
                                Yes
                            </Button>
                        </SpaceBetween>
                    </Box>
            ...
            >
                ...
                <p>
                    <strong>
                        Deleting this archive will NOT delete the data on Amazon S3 or any
                        of the associated AWS Glue jobs.
                    </strong>
                </p>
            </Modal>
        </>
