...
export class AmplifyConfigLambdaConstruct extends Construct {
	constructor(
		...
		const authorizerFn = new cdk.aws_lambda.Function(
			this,
			'AuthorizerLambda',
			{
				...
				code: cdk.aws_lambda.Code.fromInline(
					this.getAuthorizerLambdaCode()
				), // TODO: support both python and typescript versions
